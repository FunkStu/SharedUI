...
- Import from `@audere-apps/ui/primitives` (Button, Input, Badge, Tabs, Label, Checkbox, Table, Select, …), `@audere-apps/ui/surface`, `@audere-apps/ui/composition`, `@audere-apps/ui/layout` (or documented subpaths like `@audere-apps/ui/data`). Do not duplicate shadcn-style primitives in app code.
