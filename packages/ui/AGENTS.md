# @audere/ui — agent rules

- Import from `@audere/ui/primitives`, `@audere/ui/surface`, `@audere/ui/composition`, `@audere/ui/layout` (or documented subpaths like `@audere/ui/data`). Do not duplicate shadcn-style primitives in app code.
